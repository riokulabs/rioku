...
import { Anchor, Badge, Box, Button, Card, Grid, Group, Stack, Text, Title } from '@mantine/core';
import { IconArrowLeft, IconArrowRight, IconBell, IconInbox, IconRoute } from '@tabler/icons-react';
import { requirePermissions } from '@/hooks/use-before-load';
import { useChannelList } from '@/features/notification-channels';
import { useRoutingRuleList } from '@/features/notification-routing';
import { useDeliveryLogList } from '@/features/notification-log';
...
function NotificationsSettingsIndexPage() {
  ...
  const deliveryLog = useDeliveryLogList(tenantId, {
    search: '',
    statuses: [],
    channel_ids: [],
    date_from: cutoffAt,
  ...
  return (
    <Stack gap="md" p="md" data-testid="notifications-settings-index">
      ...
      <Stack gap={4}>
        ...
        <Text size="sm">
          Configure outbound notification channels, routing rules, and review delivery attempts.
          In-app inbox lives on the top-bar bell.
        </Text>
      </Stack>
          ...
          <Card withBorder p="md" h="100%">
            <Stack gap="sm" h="100%" justify="space-between">
              <Stack gap="xs">
                ...
                <Text size="sm">Map category and severity patterns to one or more channels.</Text>
                <Group gap="xs">
          ...
          <Card withBorder p="md" h="100%">
            <Stack gap="sm" h="100%" justify="space-between">
              <Stack gap="xs">
                ...
                <Text size="sm">Read-only history of delivery attempts. Last 24 hours:</Text>
                <Group gap="xs">
                  <Badge variant="light" color="green">
