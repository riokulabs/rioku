...
// The route path '/plugins/$' is not yet in FileRoutesByPath because
// routeTree.gen.ts is regenerated by vite-plugin-tanstack-router on dev-server
// start. The cast to `never` suppresses the compile-time path validation;
// TanStack Router's runtime matcher handles this path correctly once the
// route tree is rebuilt.
