...
export function RevokeAllConfirm({
  opened,
  onClose,
  currentSessionId,
}: RevokeAllConfirmProps) {
    ...
    >
      <Stack gap="md">
        <Alert icon={<IconAlertCircle size={16} />} color="orange" variant="light">
          All other active sessions will be signed out immediately. Your current
          session will remain active.
        </Alert>
        <Text size="sm">
          This is useful if you think your account has been accessed from an unknown
          device or location.
        </Text>
