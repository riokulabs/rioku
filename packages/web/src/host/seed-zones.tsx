 ...
 * fixtures. Stage-2 doesn't seed these in production; the helpers below
 * are still callable from tests that want to exercise the "plugin has
 * settings" code path without a real plugin loader.
 *
 * Registered zones:
