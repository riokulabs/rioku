...
export const getCreateUserMockHandler = (
  ...
  return http.post('*/api/v1/t/:tenant/users', async (info) => {
    await delay(1000);
    if (typeof overrideResponse === 'function') {
      await overrideResponse(info);
    }
...
export const getDeleteUserMockHandler = (
  ...
  return http.delete('*/api/v1/t/:tenant/users/:id', async (info) => {
    await delay(1000);
    if (typeof overrideResponse === 'function') {
      await overrideResponse(info);
    }
...
export const getGetUserMockHandler = (
  ...
  return http.get('*/api/v1/t/:tenant/users/:id', async (info) => {
    await delay(1000);
...
export const getPatchUserMockHandler = (
  ...
  return http.patch('*/api/v1/t/:tenant/users/:id', async (info) => {
    await delay(1000);
    if (typeof overrideResponse === 'function') {
      await overrideResponse(info);
    }
...
export const getReplaceUserMockHandler = (
  overrideResponse?:
    | void
    | ((info: Parameters<Parameters<typeof http.put>[1]>[0]) => Promise<void> | void),
) => {
  return http.put('*/api/v1/t/:tenant/users/:id', async (info) => {
    await delay(1000);
    if (typeof overrideResponse === 'function') {
      await overrideResponse(info);
    }
...
export const getActivateUserMockHandler = (
  overrideResponse?:
    | void
    | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<void> | void),
) => {
  return http.post('*/api/v1/t/:tenant/users/:id/activate', async (info) => {
    await delay(1000);
    if (typeof overrideResponse === 'function') {
      await overrideResponse(info);
    }
...
export const getLockUserMockHandler = (
  overrideResponse?:
    | void
    | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<void> | void),
) => {
  return http.post('*/api/v1/t/:tenant/users/:id/lock', async (info) => {
    await delay(1000);
    if (typeof overrideResponse === 'function') {
      await overrideResponse(info);
    }
...
export const getResetUserPasswordMockHandler = (
  ...
  return http.post('*/api/v1/t/:tenant/users/:id/reset-password', async (info) => {
    await delay(1000);
    if (typeof overrideResponse === 'function') {
      await overrideResponse(info);
    }
...
export const getSuspendUserMockHandler = (
  overrideResponse?:
    | void
    | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<void> | void),
) => {
  return http.post('*/api/v1/t/:tenant/users/:id/suspend', async (info) => {
    await delay(1000);
    if (typeof overrideResponse === 'function') {
      await overrideResponse(info);
    }
...
export const getUnlockUserMockHandler = (
  overrideResponse?:
    | void
    | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<void> | void),
) => {
  return http.post('*/api/v1/t/:tenant/users/:id/unlock', async (info) => {
    await delay(1000);
    if (typeof overrideResponse === 'function') {
      await overrideResponse(info);
    }
