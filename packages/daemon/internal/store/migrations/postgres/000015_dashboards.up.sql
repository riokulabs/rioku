...
CREATE TABLE dashboards (
    ...
    is_default      BOOLEAN NOT NULL DEFAULT FALSE,                         -- only one default per tenant (enforced in code)
...
CREATE TABLE widgets (
    ...
    raw_query       TEXT,                                                   -- only used when locked_advanced=TRUE
    locked_advanced BOOLEAN NOT NULL DEFAULT FALSE,
...
INSERT INTO schema_versions (version, dirty) VALUES (15, FALSE)
