...
CREATE TABLE notification_items (
    ...
    tenant_id VARCHAR(64) REFERENCES tenants(id) ON DELETE CASCADE,           -- nullable: super-admin broadcasts
...
INSERT IGNORE INTO schema_versions (version, dirty) VALUES (17, 0);
