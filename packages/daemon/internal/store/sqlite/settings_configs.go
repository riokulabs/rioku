...
// all four GET methods return sensible defaults when no row exists
// (so the admin UI never sees an empty state on a fresh tenant).
package sqlite
...
func (t *tx) GetNetworkConfig(ctx context.Context, tenantID string) (*store.NetworkConfig, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("sqlite: get network_config: %w", err)
	}
	return &store.NetworkConfig{
...
func (t *tx) UpsertNetworkConfig(ctx context.Context, c *store.NetworkConfig) (*store.NetworkConfig, error) {
	if c == nil || c.TenantID == "" {
		return nil, fmt.Errorf("sqlite: network_config requires tenant_id")
	}
	...
	if err != nil {
		return nil, fmt.Errorf("sqlite: upsert network_config: %w", err)
	}
...
func (t *tx) GetTenantAuthPolicy(ctx context.Context, tenantID string) (*store.TenantAuthPolicy, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("sqlite: get tenant_auth_policy: %w", err)
	}
	return &store.TenantAuthPolicy{
...
func (t *tx) UpsertTenantAuthPolicy(ctx context.Context, c *store.TenantAuthPolicy) (*store.TenantAuthPolicy, error) {
	if c == nil || c.TenantID == "" {
		return nil, fmt.Errorf("sqlite: tenant_auth_policy requires tenant_id")
	}
	policy := c.TOTPPolicy
	if policy == "" {
		policy = "optional"
...
func (t *tx) GetObservabilityConfig(ctx context.Context, tenantID string) (*store.ObservabilityConfig, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("sqlite: get observability_config: %w", err)
	}
	return &store.ObservabilityConfig{
...
func (t *tx) UpsertObservabilityConfig(ctx context.Context, c *store.ObservabilityConfig) (*store.ObservabilityConfig, error) {
	if c == nil || c.TenantID == "" {
		return nil, fmt.Errorf("sqlite: observability_config requires tenant_id")
	}
	...
	if err != nil {
		return nil, fmt.Errorf("sqlite: upsert observability_config: %w", err)
	}
...
func (t *tx) GetAuditRetentionConfig(ctx context.Context, tenantID string) (*store.AuditRetentionConfig, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("sqlite: get audit_retention_config: %w", err)
	}
	return &store.AuditRetentionConfig{
...
func (t *tx) UpsertAuditRetentionConfig(ctx context.Context, c *store.AuditRetentionConfig) (*store.AuditRetentionConfig, error) {
	if c == nil || c.TenantID == "" {
		return nil, fmt.Errorf("sqlite: audit_retention_config requires tenant_id")
	}
	...
	if err != nil {
		return nil, fmt.Errorf("sqlite: upsert audit_retention_config: %w", err)
	}
