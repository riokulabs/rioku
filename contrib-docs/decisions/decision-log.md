...
| 2026-04-06 | Default Caddy build includes 7 community plugins | coraza-caddy (WAF), caddy-l4 (TCP/UDP), cache-handler (HTTP cache), caddy-grpc-web (gRPC-Web), caddy-security (OIDC/OAuth2 bridge), realip (X-Forwarded-For), proxyprotocol (PROXY protocol v1/v2). See `caddy-plugins.md` |
