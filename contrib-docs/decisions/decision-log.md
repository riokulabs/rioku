...
| 2026-04-06 | Default Caddy build includes 5 community plugins | coraza-caddy (WAF), caddy-l4 (TCP/UDP), cache-handler (HTTP cache), caddy-grpc-web (gRPC-Web), caddy-security (OIDC/OAuth2 bridge). See `caddy-plugins.md` |
