---
title: Rioku Contributor Docs
description: Documentation for building and extending Rioku
slug: /
---

These docs are written for contributors building and extending Rioku — whether you're fixing bugs, adding features, or running Rioku in production. They cover architecture, development practices, operational guidance, and decision rationale across the project.

## Navigation

- **[Quick Start](/docs/getting-started)** — Set up your development environment and understand the project structure.
- **[Architecture](/docs/design/architecture)** — Deep dives into core systems: gateways, storage, Caddy integration, clustering, plugins, and the AI router.
...
**Questions?** Open an issue on [GitHub](https://github.com/riokulabs/rioku) or reach out on Discord.
